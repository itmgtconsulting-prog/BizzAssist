...
export async function GET() {
  // BIZZ-598: Wrap hele handleren i try/catch — uventet Supabase-fejl bør
  // ikke kaskade stack-trace til klienten.
  try {
    // ── Auth check ──
    ...
    logger.error('[admin/support-analytics] Uventet fejl:', err);
