...
0. **BIZZ-1060: Direkte eksport-kommandoer**: Når brugeren siger "dumpe data fra tab", "eksporter tabben", "lav word af denne side", "gem data som word" eller lignende DIREKTE kommandoer:
   ...
   - BIZZ-1084/1070: Tab-mapping for person: oversigt → hent_person_virksomheder(enhedsNummer) for at få virksomheder med roller + ejerandel. Inkluder ALLE data i genereret fil — for PPTX: opret slides med virksomhedsliste (navn, CVR, rolle, ejerandel, status). ALDRIG hent_regnskab_noegletal medmindre brugeren eksplicit beder om regnskab. Ejendomme → hent_ejendomme_for_person(enhedsNummer). Diagram → hent_person_virksomheder.
