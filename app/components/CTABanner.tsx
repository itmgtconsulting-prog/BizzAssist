        ...
        <div className="relative rounded-3xl overflow-hidden border border-blue-500/20 bg-gradient-to-br from-blue-600/20 via-blue-900/20 to-[#0f172a]">
          ...
          <div className="relative px-8 py-16 md:py-20 text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <Link
                href="/login"
                className="inline-flex items-center justify-center bg-white/5 hover:bg-white/10 text-white font-semibold text-lg px-8 py-4 rounded-xl border border-white/10 hover:border-white/20 transition-colors"
              >
                {cta.secondary}
              </Link>
            </div>
