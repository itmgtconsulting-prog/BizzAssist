              ...
              >
                ...
                <div className="flex items-center gap-1 flex-shrink-0">
                  ...
                  <button
                    ...
                    className="px-2 py-0.5 rounded text-[10px] font-medium bg-blue-600/20 border border-blue-600/40 text-blue-400 hover:bg-blue-600/30 transition-colors whitespace-nowrap"
                  >
                    {lang === 'da' ? 'Vælg' : 'Select'}
                  </button>
                </div>
