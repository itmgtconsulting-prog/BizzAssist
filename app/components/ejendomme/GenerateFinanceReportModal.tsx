 ...
 *
 * Viser modal med tone-vælger (realkredit/bankrådgiver/memo), streamer
 * Claude-output via /api/ai/generate-finance-report SSE-endpoint, kopiér-knap
 * og AI-disclaimer.
 *
...
export default function GenerateFinanceReportModal(props: Props): React.ReactElement | null {
  const { bfe, adresse, lang, open, onClose } = props;
  ...
  /** Annullér aktiv stream ved lukning */
  useEffect(() => {
    if (!open) {
