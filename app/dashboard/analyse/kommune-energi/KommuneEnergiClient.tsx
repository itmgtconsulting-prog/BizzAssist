/**
 * kommune-energi analyse-modul klient-komponent.
...
const modul = ANALYSE_MODULER.find((m) => m.id === 'kommune-energi')!;

/**
 * KommuneEnergiClient analyse-modul.
 *
 * @returns Analyse UI
 */
export default function KommuneEnergiClient() {
