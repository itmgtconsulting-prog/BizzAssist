                  ...
                  <div className="absolute z-10 mt-1 w-full bg-slate-900 border border-slate-700 rounded-lg shadow-xl max-h-60 overflow-y-auto">
                    {kundeResults.map((r) => (
                      <button
                        ...
                        className="w-full px-3 py-2.5 text-left hover:bg-slate-800 flex items-start gap-2.5 border-b border-slate-800 last:border-0"
                      >
                        {r.type === 'company' ? (
                          <Building2 size={14} className="text-blue-400 mt-0.5 flex-shrink-0" />
                        ) : (
                          <User size={14} className="text-purple-400 mt-0.5 flex-shrink-0" />
                        )}
