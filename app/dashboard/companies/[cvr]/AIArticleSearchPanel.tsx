 ...
 *
 * Udtrukket fra VirksomhedDetaljeClient.tsx (BIZZ-1229).
 *
...
import { Loader2, ExternalLink, ChevronDown, Lock, Zap } from 'lucide-react';
...
import { parseDateForClientSort } from './virksomhedDetailHelpers';
...
/** Props for AIArticleSearchPanel */
export interface AIArticleSearchPanelProps {
 ...
 * AIArticleSearchPanel — AI-drevet artikelsøgning i nyheds-sidepanelet.
 *
 * @param props - Se AIArticleSearchPanelProps
 */
export default function AIArticleSearchPanel({
  companyData,
  lang,
  onSocialsFound,
  onAlternativesFound,
  onThresholdFound,
}: AIArticleSearchPanelProps) {
