...
// BIZZ-787: 'documents' tab fjernet — dokumenter lever i TemplateDocumentsPanel
// som sideløbende resizable panel (se TemplateEditorSplitView).
...
export default function TemplateEditorClient({
  ...
  // BIZZ-787: Documents-tab state fjernet — al attach/guideline/upload UI
  // lever nu i TemplateDocumentsPanel (selvstændig komponent, self-contained).
  ...
  // BIZZ-787: Documents attach/upload/guidelines logik fjernet — lever nu
  // i den sideløbende TemplateDocumentsPanel (se TemplateEditorSplitView).
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 space-y-6">
      ...
      {/* BIZZ-787: Documents-section er flyttet til TemplateDocumentsPanel
          (resizable split-view til højre — se TemplateEditorSplitView). */}
