...
export const translations = {
  da: {
    ...
    company: {
      ...
      viewProperty: 'Se ejendom',
      loadingLocations: 'Henter lokationer…',
    ...
    forsikring: {
      ...
      parseFailed: 'Analyse fejlede',
      noPolicies: 'Ingen policer endnu',
      noPoliciesDesc: 'Upload din første police-PDF for at komme i gang.',
      pendingDocuments: 'Afventende dokumenter',
      colPolicy: 'Police',
      colInsurer: 'Selskab',
      colHolder: 'Forsikringstager',
      colAddress: 'Forsikringssted',
      colPremium: 'Årlig præmie',
      colExpires: 'Udløber',
      colGaps: 'Gaps',
      gapCritical: 'Kritiske',
      gapWarning: 'Advarsler',
      gapInfo: 'Info',
      totalPolicies: 'Policer',
      totalGaps: 'Detekterede gaps',
      detailBack: 'Tilbage til oversigt',
      detailPolicy: 'Police',
      detailCoverages: 'Dækninger',
      detailGaps: 'Detekterede gaps',
      detailMetadata: 'Metadata',
      detailCovered: 'Dækket',
      detailNotCovered: 'Ikke dækket',
      detailDeductible: 'Selvrisiko',
      detailSum: 'Sum',
      noGaps: 'Ingen gaps fundet — policen er solid 👍',
      gapRecommendation: 'Anbefaling',
      delete: 'Slet police',
      confirmDelete: 'Er du sikker? Det sletter også dækninger og gaps.',
      severity: {
        critical: 'Kritisk',
        warning: 'Advarsel',
        info: 'Info',
  ...
  en: {
    ...
    forsikring: {
      ...
      noPoliciesDesc: 'Upload your first policy PDF to get started.',
      pendingDocuments: 'Pending documents',
      colPolicy: 'Policy',
      colInsurer: 'Insurer',
      colHolder: 'Policyholder',
      colAddress: 'Property',
      colPremium: 'Annual premium',
      colExpires: 'Expires',
      colGaps: 'Gaps',
      gapCritical: 'Critical',
      gapWarning: 'Warnings',
      gapInfo: 'Info',
      totalPolicies: 'Policies',
      totalGaps: 'Detected gaps',
      detailBack: 'Back to overview',
      detailPolicy: 'Policy',
      detailCoverages: 'Coverages',
      detailGaps: 'Detected gaps',
      detailMetadata: 'Metadata',
      detailCovered: 'Covered',
      detailNotCovered: 'Not covered',
      detailDeductible: 'Deductible',
      detailSum: 'Sum',
      noGaps: 'No gaps found — the policy looks solid 👍',
      gapRecommendation: 'Recommendation',
      delete: 'Delete policy',
      confirmDelete: 'Are you sure? This also deletes coverages and gaps.',
      severity: {
        critical: 'Critical',
        warning: 'Warning',
        info: 'Info',
