...
const d = await r('GET','/rest/api/3/issue/BIZZ-500?fields=summary,description');
const di = JSON.parse(d.body);
console.log(`=== BIZZ-500: ${di.fields.summary}`);
console.log(flat(di.fields.description).join('').slice(0,1500));
