...
const body = {
  type:'doc', version:1, content:[
    ...
    p(txt('Bruger bekræftede manuelt: "619 kan lukkes". Persondiagrammet viser nu Jakobs personligt ejede ejendomme + IT Management consulting + fuldt virksomhedsnetværk som forventet.')),
  ],
};
...
const r = await req('POST','/rest/api/3/issue/BIZZ-619/transitions',{transition:{id:done.id}});
console.log(r.status===204?'✅ BIZZ-619 → Done':`⚠️ (${r.status})`);
